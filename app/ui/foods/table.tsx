...
export default async function FoodsTable({
  ...
  const foods = await fetchFilteredFoods(query, currentPage);
            ...
            <tbody className="bg-white">
              {foods?.map((food) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 font-medium py-3">
                    {food.calories}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    {food.carbs}/{food.protein}/{food.fat}/{food.sugar}
                  </td>
                  <td className="whitespace-nowrap py-3 pl-6 pr-3">
